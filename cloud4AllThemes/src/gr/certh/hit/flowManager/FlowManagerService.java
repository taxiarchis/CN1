...
public class FlowManagerService {
	...
	public static Hashtable parseJSONResponseWithCodenameOneParser(InputStream input) throws IOException {
	...
	public InputStream requestNeedsAndPreferences() { // Currently hardcoded for user os_jme  - later on to be retrieved by the textArea in the Login form
		String url = "http://localhost:8081/os_jme/settings/%7B%22OS%22%3A%7B%22id%22%3A%22web%22%7D%2C%22solutions%22%3A%5B%7B%22id%22%3A%22info.cloud4all.JME%22%7D%5D%7D";
...
//		con.setContentType("json/application");
